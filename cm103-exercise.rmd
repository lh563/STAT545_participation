...
```{r}
# list.len= length of the list, max.level=level of the list u want to see
...
```{r}
# can put function in the bracket
...
## method 3
`[`(x,1)=x[1]#subset x of first one elements
map_chr(wesanderson,`[`,1)
map_chr(wesanderson, x[1])
```
