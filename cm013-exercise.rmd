...
# change y axis and color, more ticks are here
```
...
# change the x axis to dollar format, color to comma format
```
...
# diverging: from hot to cold
RColorBrewer::display.brewer.all()
#top: sequentical, middle: diverging
